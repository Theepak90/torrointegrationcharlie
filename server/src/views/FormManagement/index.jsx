...
const FormManagementContainer = styled.div({
  display: 'flex',
  height: '100%',
});

const FormRenderPanel = styled.div({
  flex: 1,
...
const FormManagement = ({ tagTemplate }) => {
  ...
  return (
    <FormManagementContainer>
      <FormRenderPanel>
        <ScrollBar>
          <FormRender onClick={clickAwayHandle}>
            {formLoading && <Loading />}
