export default {
  ...
  // data exploration
  exploration: 'Explore Data Marketplace',
  dataExplore: 'Explore Data Marketplace',
  ...
  //Data Onboarding
  dataOnboarding: 'Publish Data Assets to Marketplace',
  ...
  wsManagement: 'Workspace Services',
  dataMonitoring: 'Data Assets Dashboard',
  ...
  formManagement: 'Form Builder',
  workflowManagement: 'Configure Workflows',
  bashCommand: 'Terminal',
  dataGovernaceService: 'Data Governace Services',
  dataAnalyticsService: 'Data & Analytics Services',
  inInfraServices: 'IT Infra Services',
  ...
  // Batch upload
  batchUpload: 'Batch Upload Services',
  bactchDes:
  ...
  batchUploadTagTemplate: 'Batch Upload Tag Template',
