      ...
      {lineageHealth && (
        <Box sx={{ gridColumn: '1 / -1', mt: -2 }}>
          <SummaryCards stats={{
            ...
            avg_confidence: lineageHealth.statistics?.avg_confidence,
            health_score: lineageHealth.health_score,
            completeness: lineageHealth.statistics?.completeness,
            avg_freshness_days: lineageHealth.statistics?.avg_freshness_days
          }} />
        </Box>
      )}
    </Box>
